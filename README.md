...
**2022-02-07 Vue 3 成为新的默认版本。该模板只会支持 Vue 2 最新版本到 EOL。Vue 3 模板请查看 [boilerplate-uni-app-vue3](https://github.com/MillCloud/boilerplate-uni-app-vue3)。**
...
运行到支付宝小程序时，除运行 `pnpm run dev:mp-alipay`，还需要运行 `pnpm run watch:mp-alipay` 以保证样式正确。
